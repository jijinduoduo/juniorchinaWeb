...
<html>
	...
	<?php if(is_array($info)): foreach($info as $key=>$vo): ?><form name="example" method="post" action="funddata.html">
    ID: <input type="text" readonly="readonly" name="title" value=" <?php echo ($vo["id"]); ?>">
         <br /><br />
		<textarea name="content1" style="width:1100px;height:400px;visibility:hidden;"> <?php echo ($vo["basic_info"]); ?></textarea>
		<br />
